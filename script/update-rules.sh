...
easylist_lite=(  
  ...
  "https://raw.githubusercontents.com/timlu85/AdGuard-Home_Youtube-Adfilter/master/Youtube-Adfilter-Web.txt"
)
...
dns=(
  ...
  ### 自用添加 ↓ ###
  #KoolProxy规则
  #"https://raw.iqiq.io/ilxp/koolproxy/master/rules/koolproxy.txt" #白名单
  "https://raw.iqiq.io/ilxp/koolproxy/master/rules/daily.txt"
  #"https://raw.iqiq.io/ilxp/koolproxy/master/rules/adg.txt" #adg DNS
  #"https://raw.iqiq.io/ilxp/koolproxy/master/rules/adgk.txt"
  #"https://raw.iqiq.io/ilxp/koolproxy/master/rules/yhosts.txt"
  #"https://raw.iqiq.io/ilxp/koolproxy/master/rules/steven.txt"
  #乘风 广告过滤规则 (下方已合并)
